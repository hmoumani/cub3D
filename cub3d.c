...
// // 	return (worldMap[indexY][indexX] == '1');
// // }
...
// 	int indexX = floor(pos.x / TILE_SIZE);
// 	int indexY = floor(pos.y / TILE_SIZE);
// 	return (worldMap[indexX][indexY] == '1');
// }
...
// 	while (next_horz_touchX >= 0 && next_horz_touchX <= WINDOW_HEIGHT && next_horz_touchY >= 0 && next_horz_touchY <= WINDOW_WIDTH)
// 	{
...
// 	while (next_vert_touchX >= 0 && next_vert_touchX <= WINDOW_HEIGHT && next_vert_touchY >= 0 && next_vert_touchY <= WINDOW_WIDTH)
// 	{
...
// 		draw_ray(rayAngle, rays[i].distance, color.GREEN);
...
// {
// 	skip(PLAYER_R, player.pos, color.BLUE);
// 	ft_cast_rays();
// }
...
// 		{
// 			if (worldMap[i][j] == '1')
// 				ft_square(i * TILE_SIZE, j * TILE_SIZE, color.RED, TILE_SIZE);
// 			else
// 				ft_square(i * TILE_SIZE, j * TILE_SIZE, color.BLACK, TILE_SIZE);
// 			j++;
// 		}
// 		i++;
// 	}
...
// {
// 	ft_init();
// 	ft_player(PLAYER_R, player.pos, color.BLUE);
...
// 	// exit(1);
//     g_env.ptr = mlx_init();
//     g_env.win = mlx_new_window(g_env.ptr, WINDOW_WIDTH, WINDOW_HEIGHT, "hello world!");
// 	g_env.img =  mlx_new_image(g_env.ptr, WINDOW_WIDTH, WINDOW_HEIGHT);
